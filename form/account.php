...
function MIX($p1) { return md5($p1.date('d.m.Y H').'65475g45'); }


/*
->->->->->->->->->->->->->->->->->->
->->   Edit Редактирование профил
->->->->->->->->->->->->->->->->->->
*/
...
mail($Row['email'], 'Mr.Shift', 'Ссылка для восстановления: http://chat.php/account/restore/code/'.MIX($_SESSION['RESTORE_CONFIRM']), 'From: web@mr-shift.ru');
...
if ($Module == 'register' and $_POST['enter']) {
    ...
    mail($_POST['email'], 'Регистрация', 'Ссылка для активации: http://chat.php/account/activate/code/'.MIX($_SESSION['REGISTER_CONFIRM']), 'From: web@mr-shift.ru');
...
// }
    ...
    mysqli_query($CONNECT, "INSERT INTO `users`  VALUES (null, '$Exp[0]', '$Exp[1]', '$Exp[2]', NOW(), '$Exp[3]', $Exp[4], 0, 0, 0)");
