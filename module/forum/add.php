...
mysqli_query($CONNECT, "INSERT INTO `forum`  VALUES (null, $_POST[section], NOW(), 0, '$_POST[name]', '$_SESSION[USER_LOGIN]', '$_SESSION[USER_LOGIN]', NOW())");

$id = mysqli_insert_id($CONNECT);

mysqli_query($CONNECT, "INSERT INTO `forump`  VALUES (null, $id, NOW(), '$_POST[text]', '$_SESSION[USER_LOGIN]')");
//exit('ok');
MessageSend(2, 'Тема добавлена', '/forum/main');
...
mysqli_query($CONNECT, "INSERT INTO `forump`  VALUES (null, $Param[id], NOW(), '$_POST[text]', '$_SESSION[USER_LOGIN]')");
