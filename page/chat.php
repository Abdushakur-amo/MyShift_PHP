<?php
    ...
    if ($_POST['enter'] and $_POST['text']) {
        ...
        $sql = "INSERT INTO `chat` (`id`, `message`, `user`, `time`) VALUES (NULL, '$_POST[text]', '$_SESSION[USER_NAME]', NOW())";
        ...
        <div class="content">
            ...
            <div class="ChatBox">
                <?php
                    ...
                    while ($Row = mysqli_fetch_assoc($Query)) echo '<div class="ChatBlock"><a href="/user/'.$Row['user'].'/"><span>'.$Row['user'].'</a> | '.$Row['time'].'</span>'.$Row['message'].'</div>';
                ?>
            </div>
