...
echo '
	...
	<div class="Block">
		<b>Я:</b> '.UserGroup($_SESSION['USER_GROUP']).'<br>
		<b>ID:</b>  '.$_SESSION['USER_ID'].'
		<br><b>Имя:</b>  '.$_SESSION['USER_NAME'].'
		<br><b>E-mail:</b>  '.$_SESSION['USER_EMAIL'].'
		<br><b>Страна:</b>  '.UserCountry($_SESSION['USER_COUNTRY']).'
		<br><b>Дата регистрации:</b>  '.$_SESSION['USER_REGDATE'].'
	</div>
